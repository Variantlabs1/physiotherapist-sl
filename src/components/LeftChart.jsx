...
const getNewClients = async()=>{   
  ...
  const sun =new Date(new Date(today).setDate(today.getDate()-today.getDay()));
  // console.log(sun)
...
const lastWeekClients = physioData.clientsList?.filter(c=>c.clientAcceptedOn?.toDate()>=sun)
const newClientsPercent = lastWeekClients?.length/physioData.clientsList.length*100;
...
user?.uid&&getNewClients()
  ...
  return (
    <>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="68" viewBox="0 0 55 54" fill="none">
  <path d="M43.0963 15.7732L29.759 29.1105L25.3132 24.6647L13.0874 36.8906" stroke="#00FFA3" stroke-width="2.85799"/>
  <path d="M34.2051 15.2175H43.6523V24.6648" stroke="#00FFA3" stroke-width="2.85799"/>
</svg>
                <h1>{totalClients}</h1>
                <div>
