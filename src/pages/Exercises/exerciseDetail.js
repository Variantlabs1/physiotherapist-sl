        ...
        <div className={classes.exerciseDetailsContainer}>
            ...
            <div className={classes.container}>
                <div className={classes.left}>
                    <div  className={`${classes.thumbnailContainer} ${classes.thumbnailContainerMobile}`}>
                        <img
                            className={classes.thumbnailImage}
                            src={inputs.thumbnailFile?URL.createObjectURL(inputs.thumbnailFile):exercise.thumbnailURL}
                            alt="Exercise Thumbnail"
                        />
                        {isEditing && <label className={classes.label}  htmlFor="image">Change cover photo</label>}
                        <input style={{display:'none'}}  type="file" name="thumbnail" id="image" onChange={e=>setInputs(p=>({...p,thumbnailFile:e.target.files[0]}))}  />
                    </div>

                    <div className={`${classes.aboutContainer} ${classes.aboutContainerMobile}`}>
                ...
                <div className={classes.right}>
                        ...
                        <div className={classes.descriptionContent}>
                            {isEditing ? (
                                <div className={classes.editDesc}>
                                    ...
                                    >
                                        <div className={classes.button} onClick={()=>{(handleClick) (handleEdit)}}>
                                            <p>Save</p>
                                        </div>
                                        <div >
                                            <Button className={classes.button1} onClick={handleEdit} variant='outline'>Cancel</Button>
                                        </div>
                                    </div>
                                </div>
                            ) : (
                    ...
                    <div className={`${classes.videosContainer} ${classes.videosContainerMobile}`}>
                        ...
                        <div style={{position:'relative'}}  className={classes.videoItem}>
                          ...
                          {isEditing &&  <label className={classes.label} style={{border:'none',cursor:'none',width:'35%'}}  htmlFor="video" >
                              <span><CloudUploadIcon fontSize="large" /></span>
                              <label className={classes.label} htmlFor="video"  >Upload new</label>
                          </label>}
